...
def update_db_from_SAGE_command():
    loading_window_from_SAGE = LoadingWindow(app.root, update_db_from_SAGE)

def generate_model_files_from_backup_command():
    loading_window_backup = LoadingWindow(app.root, generate_model_files_from_backup)
...
display_info_widget = tk.Text(display_info_frm, wrap = 'word', state = 'disabled', relief = tk.FLAT, bg = 'white smoke')
